...
AWS_ACCESS_KEY_ID = SECRETS['base']['AWS_ACCESS_KEY_ID']
AWS_SECRET_ACCESS_KEY = SECRETS['base']['AWS_SECRET_ACCESS_KEY']
...
DATABASES = {
    'default': {
        ...
        'NAME': 'instagram',
        'USER': SECRETS['base']['POSTGRESQL_USER'],
        'PASSWORD': SECRETS['base']['POSTGRESQL_PASSWORD'],
